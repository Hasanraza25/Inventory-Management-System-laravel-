            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('customer.add') }}" class="btn btn-dark waves-effect waves-light btn-rounded" style="float:right;">Add Customer</a> <br> <br>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('customer.destroy',$item->id) }}" class="btn btn-danger sm" title="Delete Data" id="delete"> <i class="fas fa-trash-alt"></i> </a>
